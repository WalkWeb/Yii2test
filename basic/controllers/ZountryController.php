...
class ZountryController extends Controller
{
    ...
    /**
     * Displays a single Zountry model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Zountry model.
    ...
    /**
     * Deletes an existing Zountry model.
    ...
    /**
     * Finds the Zountry model based on its primary key value.
